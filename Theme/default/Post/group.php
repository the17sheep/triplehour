			...
			<div class="col-sm-8">
				<h1>
					<a id="logo" class="pull-left img-div"
						href="<?php echo mc_get_url($_GET['id']); ?>"><img
						src="<?php echo mc_fmimg($_GET['id']); ?>"></a> <a
						href="<?php echo mc_get_url($_GET['id']); ?>"
						class="pull-left title">
							<?php if(mc_get_page_field($_GET['id'],'type')=='pro') : //项目版块 ?>
	...
	<div class="row">
		<div class="col-sm-8 col-lg-9" id="group">
				...
				<div class="text-center">
					...
					<a href="<?php echo U('publish/index/edit?id='.$_GET['id']); ?>"
		...
		<div class="col-sm-4 col-lg-3 hidden-xs" id="group-side">
			<ul class="nav nav-pills nav-stacked text-center mb-20">
				<li class="active"><a
					href="<?php echo U('post/group/single?id='.$_GET['id']); ?>">全部主题</a></li>
				<li><a
					href="<?php echo U('publish/index/add_post?group='.$_GET['id']); ?>">发起话题</a></li>
					<?php if(mc_is_admin() || mc_is_bianji()) : ?>
				...
				<?php if(mc_get_page_field($_GET['id'],'type')=='pro') : //项目版块 ?>
			<div class="thumbnail">
								<?php $fmimg_args = mc_get_meta($_GET['id'],'fmimgcover',false); $fmimg_args = array_reverse($fmimg_args); ?>
								<a class="img-div" href="<?php echo mc_get_url($_GET['id']); ?>"><img
					src="<?php echo $fmimg_args[0]; ?>"
					alt="<?php echo mc_get_page_field($_GET['id'],'title'); ?>"></a>
				<div class="caption">
					<h4 class="mt-0">
						<a href="<?php echo mc_get_url($_GET['id']); ?>"><?php echo mc_get_page_field($group_id,'title'); ?></a>
					</h4>
					<div class="price pull-left mt-0">
						<small>预计投资:</small><span><?php echo sprintf("%.2f",mc_get_meta($_GET['id'], 'tol_price')/10000); ?></span>
						<small>万</small>
					</div>
					<button type="button" class="btn btn-warning btn-xs pull-right">
									<?php echo mc_get_meta($_GET['id'], 'pro_province');?>
								</button>
