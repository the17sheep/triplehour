...
<div class="container">
	<div class="row">
		<div
			class="col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 pr-0 pl-0">
			<ol class="breadcrumb mb-0" id="baobei-term-breadcrumb">
				...
				<li><a
					href="<?php echo U('article/index/term?id='.mc_get_meta($val['id'],'term')); ?>">
	...
	<div class="row">
		<div
			...
			<div id="single">
				...
				<div id="entry" class="pl-10 pr-10">
					<?php echo mc_magic_out($val['content']); ?>
				</div>
				<?php if(mc_get_meta($val['id'],'tag',false)) : ?>
				<ul id="tags" class="list-inline pl-10 pr-10">
					<li><i class="icon-tags"></i></li>
					<?php foreach(mc_get_meta($val['id'],'tag',false) as $tag) : ?>
					<li><a href="http://www.triplehour.com"><?php echo $tag; ?></a></li>
					<?php endforeach; ?>
				</ul>
				<?php endif; ?>
				<hr>
				<div class="text-center">
				<?php if (mc_user_id() == mc_author_id($val['id'])): ?>
					...
					<?php elseif(!mc_is_admin() && !mc_is_bianji()) : ?>
					<?php echo mc_xihuan_btn($val['id']); ?>
					<?php echo mc_shoucang_btn($val['id']); ?>
					<?php elseif(mc_is_admin() || mc_is_bianji() ) : ?>
					<?php if(mc_get_page_field($val['id'],'type')=='article_pending') : ?>
					<form method="post"
						action="<?php echo U('home/perform/review_article'); ?>"
						class="inline">
