...
list2[list2.length] = new Array("城市/地区/自治州");
...
list2[list2.length] = new Array("重庆市区", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "万盛区", "双桥区", "渝北区", "巴南区", "万州区", "涪陵区", "黔江区", "长寿区", "合川市", "永川市", "江津市", "南川市", "綦江县", "潼南县", "铜梁县", "大足县", "璧山县", "垫江县", "武隆县", "丰都县", "城口县", "开县", "巫溪县", "巫山县", "奉节县", "云阳县", "忠县", "石柱土家族自治县", "彭水苗族土家族自治县", "酉阳土家族苗族自治县", "秀山土家族苗族自治县", "其他");
...
//编辑页面根据数据库的值设置地址
var oldprovince = document.getElementsByName("old_province")[0].value;
var oldcity = document.getElementsByName("old_city")[0].value;
if (oldprovince != null && oldprovince.length > 0 && oldcity != null && oldcity.length > 0) {
