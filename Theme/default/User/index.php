		...
		<div class="row">
					...
					<li class="list-group-item" id="mc-page-<?php echo $val['id']; ?>">
						<div class="media">
							...
							<a class="pull-left" href="<?php echo mc_get_url($user_id); ?>">
								...
								src="<?php echo mc_user_avatar($user_id); ?>"
								alt="<?php echo mc_user_display_name($user_id); ?>">
							</a>
            ...
            :
                ...
                :
                    ?>
										在 <a
										href="<?php echo mc_get_url($comment_page_id); ?>#comment-<?php echo $value; ?>"><?php echo mc_get_page_field($comment_page_id,'title'); ?></a> 中，@了 你：
										<?php else : ?>
										在 <a
										href="<?php echo mc_get_url($comment_page_id); ?>#comment-<?php echo $value; ?>"><?php echo mc_get_page_field($comment_page_id,'title'); ?></a>
									中，@了 <a href="<?php echo mc_get_url($page_id); ?>"><?php echo mc_get_page_field($page_id,'title'); ?></a>：
										<?php endif; ?>
            ...
            :
                ...
                :
                    ...
                    ?>
										在 <a href="<?php echo mc_get_url($group); ?>"><?php echo mc_get_page_field($group,'title'); ?></a>
									中发布了新主题 <a href="<?php echo mc_get_url($page_id); ?>"><?php echo mc_get_page_field($page_id,'title'); ?></a>：
										...
										<?php elseif($type=='pro') : ?>
										发布了项目 <a href="<?php echo mc_get_url($page_id); ?>"><?php echo mc_get_page_field($page_id,'title'); ?></a>：
										<?php endif; ?>
            ...
            :
                ...
                :
                    ?>
										喜欢了<?php echo $name; ?> <a
										href="<?php echo mc_get_url($page_id); ?>"><?php echo mc_get_page_field($page_id,'title'); ?></a>：
                    ...
                    ?>
								...
								<?php elseif($key=='publish') : ?>
									...
									<p>
									<a href="<?php echo mc_get_url($page_id); ?>"><img
										src="<?php echo mc_fmimg($page_id); ?>" /></a>
								</p>
									<?php else : ?>
								...
								<?php elseif($key=='wish') : ?>
								<p>
									支持金额：<span class="text-danger"><?php echo $value; ?></span>元
								</p>
								<?php endif; ?>
								<p class="post-info">
			...
			<div class="col-md-4 col-lg-3 hidden-xs hidden-sm home-side">
					...
					<div class="panel-heading">
						<i class="icon-th-list"></i> 最新项目 <a class="pull-right"
						...
						<ul class="list-group">
							...
							<div class="media">
								<a class="pull-left img-div"
									href="<?php echo mc_get_url($val['id']); ?>">
									...
									alt="<?php echo mc_get_page_field($val['id'],'title'); ?>">
								</a>
								<div class="media-body">
									...
									<p>
										<small>已合伙:</small><span><?php echo sprintf("%.2f",mc_get_meta($val['id'], 'tol_price')/10000); ?></span>
										<small>元</small>
									</p>
						...
						<?php else : ?>
						<div class="panel-body">暂时没有任何项目</div>
						<?php endif; ?>
					</div>
					<?php endif; ?>
					...
					<div class="panel panel-default">
					<div class="panel-heading">
						<i class="icon-th-list"></i> 最新话题 <a class="pull-right"
							href="<?php echo U('publish/index/add_post'); ?>"><i
							class="icon-plus"></i></a>
					</div>
						<?php
        $newpost = M('page')->where("type='publish'")
            ->order('id desc')
            ->page(1, 3)
            ->select();
        if ($newpost)
        :
            ?>
						<ul class="list-group">
							...
							<div class="media">
								<a class="pull-left img-div"
									href="<?php echo mc_get_url($author); ?>"> <img
									class="media-object"
						...
						<?php else : ?>
						<div class="panel-body">暂时没有任何分享</div>
						<?php endif; ?>
					</div>
					<?php endif; ?>
					...
					<div class="panel-heading">
						...
						<?php else : ?>
						<div class="panel-body">暂时没有任何文章</div>
						<?php endif; ?>
					</div>
					<?php endif; ?>
				</div>
