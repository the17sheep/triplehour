			...
			<div class="col-lg-12">
				...
				<form role="form" method="post" action="<?php echo mc_page_url(); ?>">
				    <div class="form-group">
				        ...
				        <input type="hidden" name="title" class="form-control" value="<?php echo mc_get_meta(mc_user_id(),'user_name',true,'user'); ?>">
				        <p class="help-block">
				            用户名无法修改
				        </p>
				    </div>
				    ...
				    <div class="form-group">
				        ...
				        <input name="buyer_name" type="text" class="form-control" value="<?php echo mc_get_meta(mc_user_id(),'buyer_name',true,'user'); ?>" placeholder="联系人姓名">
				    </div>
				    <div class="form-group">
				    	<div class="row">
				    		<div class="col-sm-6">
