...
<div class="container">
	<ol class="breadcrumb mb-20 mt-20" id="baobei-term-breadcrumb">
		...
		<li><a href="<?php echo U('post/group/index'); ?>"> 群组 </a></li>
		<li><a
			href="<?php echo U('post/group/single?id='.mc_get_meta($_GET['id'],'group')); ?>">
				...
				<div class="row">
					<div class="col-sm-4 col-lg-3">
						<div class="form-group">
							<label> 群组 </label> <select class="form-control" name="group">
					...
					<div class="col-sm-8 col-lg-9">
						<div class="form-group">
							<label> 标题 </label> <input name="title" type="text"
								...
								value="<?php echo mc_get_page_field($_GET['id'],'title'); ?>">
						</div>
					</div>
				</div>
				<div class="form-group">
