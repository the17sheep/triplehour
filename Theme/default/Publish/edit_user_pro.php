...
<form role="form" id="edit_user_pro_form" method="post"
				...
				<div class="col-sm-12" id="pro-index-tl">
					<div id="pro-index-tlin">
						<div id="carousel-example-generic" class="carousel slide"
							data-ride="carousel">
							<ol class="carousel-indicators" id="publish-carousel-indicators"><?php $num0 = 0; $fmimg = mc_get_meta($_GET['id'],'fmimg',false); $fmimg = array_reverse($fmimg); foreach($fmimg as $val) : $num0++; ?><li
	...
	<div class="container" id="pro-single">
		<div class="col-sm-8" id="single">
			...
			<div style="text-align: center;" class="form-group">
				<input type="text" name="tp_verify"
		...
		<div class="col-sm-4" id="pro-index-tr">
			...
			<?php $fmimgcover = mc_get_meta($_GET['id'],'fmimgcover');?>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<select class="form-control" id="city" tabindex="4"
								disabled="disabled" runat="server" name="pro_city"
								required="required"></select>
						</div>
				...
				<input name="min_share" type="hidden" class="form-control"
					placeholder="请填写最小合伙份数"
					value="<?php echo mc_get_meta($_GET['id'],'min_share'); ?>"> <input
					name="xiaoliang" type="hidden" class="form-control"
					placeholder="请填写已合伙份数"
					value="<?php echo mc_get_meta($_GET['id'],'xiaoliang'); ?>"> <input
					name="num_people" type="hidden" class="form-control"
...
<style>
#edit_user_pro_form label.error {
	padding-left: 16px;
	margin-left: 2px;
	font-size: 14px;
	color: red;
