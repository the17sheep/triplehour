...
<form role="form" method="post"
	action="<?php echo U('home/perform/publish_pro'); ?>">
	<div id="single-top">
	...
	<div class="container pt-0" id="pro-single">
		<div class="col-sm-8" id="single">
			<div id="entry">
				<div class="form-group">
					<textarea name="content" class="form-control" rows="3" required="required">在这里添加项目的详细描述</textarea>
				</div>
			</div>
			<div class="form-group">
		...
		<div class="col-sm-4" id="pro-index-tr">
			<div id="pro-index-trin">
				...
				<h1>
					<textarea name="title" class="form-control" placeholder="请填写项目标题" required="required"></textarea>
				</h1>
				<h3>
					<div class="row">
						<div class="col-sm-6">
							<select class="form-control" id="province" tabindex="4"
								...
								name="pro_province" datatype="*" errormsg="必须选择项目所在的地区" required="required"></select>
						</div>
						<div class="col-sm-6">
				...
				<h3>
					<textarea name="brief" class="form-control" placeholder="请填写项目简要说明" required="required"></textarea>
				</h3>
				<h3>
					<input name="vedio" type="text" class="form-control"
						placeholder="请填写视频地址">
				</h3>
				<h3>
					<div class="row">
						<div class="input-group">
							...
							<input name="tol_price" type="number" class="form-control"
								placeholder="请填写项目资金需求" required="required"> <span class="input-group-addon"> 元 </span>
						</div>
					</div>
				</h3>
				<h3>
					<div class="row">
						<div class="input-group">
							<input name="kucun" type="number" class="form-control"
								placeholder="请填写项目资金需求分为多少份" required="required"><span class="input-group-addon"> 份
							</span>
						</div>
					</div>
				</h3>
					...
					<div class="row">
						<div class="input-group">
							<input name="partners" type="number" class="form-control"
								placeholder="请填写期望合伙人数" required="required"><span class="input-group-addon"> 人 </span>
						</div>
					</div>
				</h3>
				<h3>
					<div class="row">
						<div class="input-group">
							<input name="days" type="number" class="form-control"
								placeholder="请填写项目上线天数" required="required"><span class="input-group-addon"> 天</span>
						</div>
					</div>
				</h3>
				<div class="form-group">
					...
					<div class="row">
						<div class="input-group">
							<input name="min_share" type="number" class="form-control"
								placeholder="请填写最小合伙份数" required="required"> <span class="input-group-addon"> 份 </span>
						</div>
					</div>
				</h3>
				<h3>
					<div class="row">
						<div class="input-group">
							<input name="xiaoliang" type="number" class="form-control"
								placeholder="请填写已合伙份数" required="required"><span class="input-group-addon"> 份 </span>
						</div>
					</div>
				</h3>
				<h3>
					<div class="row">
						<div class="input-group">
							<input name="num_people" type="number" class="form-control"
								placeholder="请填写已合伙人数" required="required"><span class="input-group-addon"> 人</span>
						</div>
					</div>
				</h3>
