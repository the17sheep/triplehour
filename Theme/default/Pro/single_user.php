		...
		<div class="col-md-8 col-lg-8  mb-20 mt-10">
			<div id="pro-single" class="row mb-20 bc-1-s-g">
				<div class="col-sm-12" id="single">
					...
					<?php elseif(mc_is_admin() || mc_is_bianji() ) : ?>
					<?php if(mc_get_page_field($val['id'],'type')=='pro_pending') : ?>
					<form method="post"
							action="<?php echo U('home/perform/review_pro'); ?>"
							class="inline">
				...
				<div class="row">
					<div class="col-sm-12" id="pro-index-tr">
						...
						<?php else : ?>
						 ...
						 <div class="btn-group mb-20" style="TEXT-ALIGN: center; width: 100%;">
...
<?php if(mc_is_admin() || mc_is_bianji() || (mc_user_id() == mc_author_id($val['id'])) ) : ?>
<!-- Modal -->
<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body text-center">确认要删除这个未审核项目吗？</div>
