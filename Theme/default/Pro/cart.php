	...
	<div class="container">
		<div class="panel panel-default" id="cart">
			...
			<div class="panel-heading">
				<i class="glyphicon glyphicon-shopping-cart"></i> 我合伙完成的项目
			</div>
			<?php if($page) : ?>
			<ul class="list-group">
			...
			<li class="list-group-item pr">
				<div class="media">
					...
					<div class="media-body">
						...
						<span class="btn btn-danger btn-sm">合伙金额：<?php echo mc_cart_price($val['id']); ?> 元</span>
						<span class="btn btn-info btn-sm">份额：<?php echo $val['action_value']; ?></span>
			...
			<div class="panel-footer">
				<div class="row">
					<div class="col-sm-6">
						<div class="btn btn-link" id="total">项目总价：<span><?php echo mc_total(); ?></span> 元</div>
					</div>
			...
			<?php else : ?>
			<div class="panel-body text-center">我合伙完成的项目里没有任何项目</div>
			<?php endif; ?>
		</div>
	</div>
