...
function mc_publish_user_article_end($page_id)
{//用户发布文章行为--pope
	$user_id = mc_user_id();
	$action['page_id'] = $page_id;
	$action['user_id'] = $user_id;
...
;
add_go('publish_user_article_end', 'mc_publish_user_article_end');
...
// 用户发项目行为--pope
function mc_publish_user_pro_end($page_id)
{
	$user_id = mc_user_id();
	$action['page_id'] = $page_id;
	$action['user_id'] = $user_id;
...
;
add_go('publish_user_pro_end', 'mc_publish_user_pro_end');
